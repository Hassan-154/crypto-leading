      ...
      <div className="text-center space-y-6">
        ...
        <div className="text-md sm:text-lg leading-relaxed space-y-4">
          ...
          <p>
            ...
            their tax positions. From managing complex DeFi transactions to navigating NFT capital gains and
            preparing tax-ready reports, our team brings clarity and structure to a decentralized world.
          </p>
        </div>
      </div>
    </div>
